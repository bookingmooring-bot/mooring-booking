...
const Testimonials = () => {
  ...
  const testimonials = [
    ...
    {
      id: 2,
      content: t('testimonials.sailor2', "Upgraded to Premium and it changed everything! Unlimited AI Captain, offline maps, storm alerts — worth every cent. Plus saved 55% on my Adriatic trip."),
      author: "Miljan Ć.",
